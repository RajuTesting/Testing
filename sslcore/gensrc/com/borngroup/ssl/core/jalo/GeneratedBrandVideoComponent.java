...
/**
 * Generated class for type {@link com.borngroup.ssl.core.jalo.BrandVideoComponent BrandVideoComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedBrandVideoComponent extends SimpleCMSComponent
{
	/** Qualifier of the <code>BrandVideoComponent.text</code> attribute **/
	public static final String TEXT = "text";
	/** Qualifier of the <code>BrandVideoComponent.URL</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>BrandVideoComponent.text</code> attribute.
	...
	public String getText(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedBrandVideoComponent.getText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>BrandVideoComponent.text</code> attribute. 
	...
	public void setText(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedBrandVideoComponent.setText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>BrandVideoComponent.URL</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>BrandVideoComponent.URL</code> attribute. 
