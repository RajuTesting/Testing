...
/**
 * Generated class for type {@link com.borngroup.ssl.core.jalo.SslProductValueDiscountPromotion SslProductValueDiscountPromotion}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedSslProductValueDiscountPromotion extends ProductPromotion
{
	/** Qualifier of the <code>SslProductValueDiscountPromotion.valueDiscount</code> attribute **/
	public static final String VALUEDISCOUNT = "valueDiscount";
	/** Qualifier of the <code>SslProductValueDiscountPromotion.messageFired</code> attribute **/
	public static final String MESSAGEFIRED = "messageFired";
	/** Qualifier of the <code>SslProductValueDiscountPromotion.messageCouldHaveFired</code> attribute **/
	...
	static
	{
		...
		tmp.put(VALUEDISCOUNT, AttributeMode.INITIAL);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SslProductValueDiscountPromotion.messageCouldHaveFired</code> attribute.
	...
	public String getMessageCouldHaveFired(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSslProductValueDiscountPromotion.getMessageCouldHaveFired requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SslProductValueDiscountPromotion.messageCouldHaveFired</code> attribute. 
	...
	public void setMessageCouldHaveFired(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSslProductValueDiscountPromotion.setMessageCouldHaveFired requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SslProductValueDiscountPromotion.messageFired</code> attribute.
	...
	public String getMessageFired(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSslProductValueDiscountPromotion.getMessageFired requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SslProductValueDiscountPromotion.messageFired</code> attribute. 
	...
	public void setMessageFired(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSslProductValueDiscountPromotion.setMessageFired requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SslProductValueDiscountPromotion.valueDiscount</code> attribute.
	 * @return the valueDiscount - Value discount for the products in specific currencies.
	 */
	public Collection<PromotionPriceRow> getValueDiscount(final SessionContext ctx)
	{
		Collection<PromotionPriceRow> coll = (Collection<PromotionPriceRow>)getProperty( ctx, VALUEDISCOUNT);
	 ...
	 * @return the valueDiscount - Value discount for the products in specific currencies.
	 */
	public Collection<PromotionPriceRow> getValueDiscount()
	{
		return getValueDiscount( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>SslProductValueDiscountPromotion.valueDiscount</code> attribute. 
	 * @param value the valueDiscount - Value discount for the products in specific currencies.
	 */
	public void setValueDiscount(final SessionContext ctx, final Collection<PromotionPriceRow> value)
	{
		new PartOfHandler<Collection<PromotionPriceRow>>()
		{
			...
			protected void doSetValue(final SessionContext ctx, final Collection<PromotionPriceRow> _value)
			{
				...
				setProperty(ctx, VALUEDISCOUNT,value == null || !value.isEmpty() ? value : null );
			}
		}.setValue( ctx, value );
	}
	 ...
	 * @param value the valueDiscount - Value discount for the products in specific currencies.
	 */
	public void setValueDiscount(final Collection<PromotionPriceRow> value)
	{
		setValueDiscount( getSession().getSessionContext(), value );
	}
