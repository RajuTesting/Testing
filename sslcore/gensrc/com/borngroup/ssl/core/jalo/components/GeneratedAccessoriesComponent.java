...
/**
 * Generated class for type {@link com.borngroup.ssl.core.jalo.components.AccessoriesComponent AccessoriesComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedAccessoriesComponent extends CMSImageComponent
{
	/** Qualifier of the <code>AccessoriesComponent.header</code> attribute **/
	public static final String HEADER = "header";
	/** Qualifier of the <code>AccessoriesComponent.text</code> attribute **/
	public static final String TEXT = "text";
	/** Qualifier of the <code>AccessoriesComponent.URL</code> attribute **/
	public static final String URL = "URL";
	/** Qualifier of the <code>AccessoriesComponent.linkText</code> attribute **/
	public static final String LINKTEXT = "linkText";
	/** Qualifier of the <code>AccessoriesComponent.linkUrl</code> attribute **/
	public static final String LINKURL = "linkUrl";
	/** Qualifier of the <code>AccessoriesComponent.defaultBanner</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AccessoriesComponent.defaultBanner</code> attribute.
	...
	public Media getDefaultBanner(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedAccessoriesComponent.getDefaultBanner requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>AccessoriesComponent.defaultBanner</code> attribute. 
	...
	public void setDefaultBanner(final SessionContext ctx, final Media value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedAccessoriesComponent.setDefaultBanner requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AccessoriesComponent.header</code> attribute.
	...
	public String getHeader(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedAccessoriesComponent.getHeader requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>AccessoriesComponent.header</code> attribute. 
	...
	public void setHeader(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedAccessoriesComponent.setHeader requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AccessoriesComponent.linkText</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>AccessoriesComponent.linkText</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AccessoriesComponent.linkUrl</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>AccessoriesComponent.linkUrl</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AccessoriesComponent.text</code> attribute.
	...
	public String getText(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedAccessoriesComponent.getText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>AccessoriesComponent.text</code> attribute. 
	...
	public void setText(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedAccessoriesComponent.setText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>AccessoriesComponent.URL</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>AccessoriesComponent.URL</code> attribute. 
