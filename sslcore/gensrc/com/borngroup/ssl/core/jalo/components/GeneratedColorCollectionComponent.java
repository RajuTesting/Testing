...
/**
 * Generated class for type {@link com.borngroup.ssl.core.jalo.components.ColorCollectionComponent ColorCollectionComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedColorCollectionComponent extends CMSImageComponent
{
	/** Qualifier of the <code>ColorCollectionComponent.mobileMedia</code> attribute **/
	public static final String MOBILEMEDIA = "mobileMedia";
	/** Qualifier of the <code>ColorCollectionComponent.header</code> attribute **/
	public static final String HEADER = "header";
	/** Qualifier of the <code>ColorCollectionComponent.text</code> attribute **/
	public static final String TEXT = "text";
	/** Qualifier of the <code>ColorCollectionComponent.URL</code> attribute **/
	public static final String URL = "URL";
	/** Qualifier of the <code>ColorCollectionComponent.linkUrl</code> attribute **/
	public static final String LINKURL = "linkUrl";
	/** Qualifier of the <code>ColorCollectionComponent.linkText</code> attribute **/
	public static final String LINKTEXT = "linkText";
	/** Qualifier of the <code>ColorCollectionComponent.defaultBanner</code> attribute **/
	...
	static
	{
		...
		tmp.put(MOBILEMEDIA, AttributeMode.INITIAL);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ColorCollectionComponent.defaultBanner</code> attribute.
	...
	public Media getDefaultBanner(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedColorCollectionComponent.getDefaultBanner requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>ColorCollectionComponent.defaultBanner</code> attribute. 
	...
	public void setDefaultBanner(final SessionContext ctx, final Media value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedColorCollectionComponent.setDefaultBanner requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ColorCollectionComponent.header</code> attribute.
	...
	public String getHeader(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedColorCollectionComponent.getHeader requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>ColorCollectionComponent.header</code> attribute. 
	...
	public void setHeader(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedColorCollectionComponent.setHeader requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ColorCollectionComponent.linkText</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>ColorCollectionComponent.linkText</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ColorCollectionComponent.linkUrl</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>ColorCollectionComponent.linkUrl</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ColorCollectionComponent.mobileMedia</code> attribute.
	 * @return the mobileMedia - Attribute that stores the localized mobile media of
	 *                             the paragraph.
	 */
	public Media getMobileMedia(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedColorCollectionComponent.getMobileMedia requires a session language", 0 );
		}
		return (Media)getLocalizedProperty( ctx, MOBILEMEDIA);
	}
	 ...
	 *                             the paragraph.
	 */
	public Media getMobileMedia()
	{
		return getMobileMedia( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>ColorCollectionComponent.mobileMedia</code> attribute. 
	 * @return the localized mobileMedia - Attribute that stores the localized mobile media of
	 *                             the paragraph.
	 */
	public Map<Language,Media> getAllMobileMedia(final SessionContext ctx)
	{
		return (Map<Language,Media>)getAllLocalizedProperties(ctx,MOBILEMEDIA,C2LManager.getInstance().getAllLanguages());
	}
	 ...
	 *                             the paragraph.
	 */
	public Map<Language,Media> getAllMobileMedia()
	{
		return getAllMobileMedia( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>ColorCollectionComponent.mobileMedia</code> attribute. 
	 * @param value the mobileMedia - Attribute that stores the localized mobile media of
	 *                             the paragraph.
	 */
	public void setMobileMedia(final SessionContext ctx, final Media value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedColorCollectionComponent.setMobileMedia requires a session language", 0 );
		}
		setLocalizedProperty(ctx, MOBILEMEDIA,value);
	}
	 ...
	 *                             the paragraph.
	 */
	public void setMobileMedia(final Media value)
	{
		setMobileMedia( getSession().getSessionContext(), value );
	}
	 ...
	 *                             the paragraph.
	 */
	public void setAllMobileMedia(final SessionContext ctx, final Map<Language,Media> value)
	{
		setAllLocalizedProperties(ctx,MOBILEMEDIA,value);
	}
	 ...
	 *                             the paragraph.
	 */
	public void setAllMobileMedia(final Map<Language,Media> value)
	{
		setAllMobileMedia( getSession().getSessionContext(), value );
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>ColorCollectionComponent.text</code> attribute.
	...
	public String getText(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedColorCollectionComponent.getText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>ColorCollectionComponent.text</code> attribute. 
	...
	public void setText(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedColorCollectionComponent.setText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ColorCollectionComponent.URL</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>ColorCollectionComponent.URL</code> attribute. 
