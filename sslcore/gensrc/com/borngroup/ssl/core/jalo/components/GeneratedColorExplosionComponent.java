...
/**
 * Generated class for type {@link com.borngroup.ssl.core.jalo.components.ColorExplosionComponent ColorExplosionComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedColorExplosionComponent extends CMSImageComponent
{
	/** Qualifier of the <code>ColorExplosionComponent.header</code> attribute **/
	public static final String HEADER = "header";
	/** Qualifier of the <code>ColorExplosionComponent.text</code> attribute **/
	public static final String TEXT = "text";
	/** Qualifier of the <code>ColorExplosionComponent.URL</code> attribute **/
	public static final String URL = "URL";
	/** Qualifier of the <code>ColorExplosionComponent.linkUrl</code> attribute **/
	public static final String LINKURL = "linkUrl";
	/** Qualifier of the <code>ColorExplosionComponent.linkText</code> attribute **/
	public static final String LINKTEXT = "linkText";
	/** Qualifier of the <code>ColorExplosionComponent.defaultBanner</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ColorExplosionComponent.defaultBanner</code> attribute.
	...
	public Media getDefaultBanner(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedColorExplosionComponent.getDefaultBanner requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>ColorExplosionComponent.defaultBanner</code> attribute. 
	...
	public void setDefaultBanner(final SessionContext ctx, final Media value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedColorExplosionComponent.setDefaultBanner requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ColorExplosionComponent.header</code> attribute.
	...
	public String getHeader(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedColorExplosionComponent.getHeader requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>ColorExplosionComponent.header</code> attribute. 
	...
	public void setHeader(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedColorExplosionComponent.setHeader requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ColorExplosionComponent.linkText</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>ColorExplosionComponent.linkText</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ColorExplosionComponent.linkUrl</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>ColorExplosionComponent.linkUrl</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ColorExplosionComponent.text</code> attribute.
	...
	public String getText(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedColorExplosionComponent.getText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>ColorExplosionComponent.text</code> attribute. 
	...
	public void setText(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedColorExplosionComponent.setText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ColorExplosionComponent.URL</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>ColorExplosionComponent.URL</code> attribute. 
