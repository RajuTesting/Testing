...
/**
 * Generated class for type {@link com.borngroup.ssl.core.jalo.components.FrequentlySearchedComponent FrequentlySearchedComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedFrequentlySearchedComponent extends SimpleCMSComponent
{
	/** Qualifier of the <code>FrequentlySearchedComponent.imageList</code> attribute **/
	public static final String IMAGELIST = "imageList";
	/** Qualifier of the <code>FrequentlySearchedComponent.headline</code> attribute **/
	public static final String HEADLINE = "headline";
	/** Qualifier of the <code>FrequentlySearchedComponent.description</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>FrequentlySearchedComponent.description</code> attribute.
	...
	public String getDescription(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedFrequentlySearchedComponent.getDescription requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>FrequentlySearchedComponent.description</code> attribute. 
	...
	public void setDescription(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedFrequentlySearchedComponent.setDescription requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>FrequentlySearchedComponent.headline</code> attribute.
	...
	public String getHeadline(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedFrequentlySearchedComponent.getHeadline requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>FrequentlySearchedComponent.headline</code> attribute. 
	...
	public void setHeadline(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedFrequentlySearchedComponent.setHeadline requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>FrequentlySearchedComponent.imageList</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>FrequentlySearchedComponent.imageList</code> attribute. 
