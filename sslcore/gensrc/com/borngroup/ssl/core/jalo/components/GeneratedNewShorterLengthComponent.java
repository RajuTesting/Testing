...
/**
 * Generated class for type {@link com.borngroup.ssl.core.jalo.components.NewShorterLengthComponent NewShorterLengthComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedNewShorterLengthComponent extends CMSImageComponent
{
	/** Qualifier of the <code>NewShorterLengthComponent.text</code> attribute **/
	public static final String TEXT = "text";
	/** Qualifier of the <code>NewShorterLengthComponent.URL</code> attribute **/
	public static final String URL = "URL";
	/** Qualifier of the <code>NewShorterLengthComponent.header</code> attribute **/
	public static final String HEADER = "header";
	/** Qualifier of the <code>NewShorterLengthComponent.linkUrl</code> attribute **/
	public static final String LINKURL = "linkUrl";
	/** Qualifier of the <code>NewShorterLengthComponent.linkText</code> attribute **/
	public static final String LINKTEXT = "linkText";
	/** Qualifier of the <code>NewShorterLengthComponent.defaultBanner</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>NewShorterLengthComponent.defaultBanner</code> attribute.
	...
	public Media getDefaultBanner(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedNewShorterLengthComponent.getDefaultBanner requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>NewShorterLengthComponent.defaultBanner</code> attribute. 
	...
	public void setDefaultBanner(final SessionContext ctx, final Media value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedNewShorterLengthComponent.setDefaultBanner requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>NewShorterLengthComponent.header</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>NewShorterLengthComponent.header</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>NewShorterLengthComponent.linkText</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>NewShorterLengthComponent.linkText</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>NewShorterLengthComponent.linkUrl</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>NewShorterLengthComponent.linkUrl</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>NewShorterLengthComponent.text</code> attribute.
	...
	public String getText(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedNewShorterLengthComponent.getText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>NewShorterLengthComponent.text</code> attribute. 
	...
	public void setText(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedNewShorterLengthComponent.setText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>NewShorterLengthComponent.URL</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>NewShorterLengthComponent.URL</code> attribute. 
