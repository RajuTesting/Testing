...
/**
 * Generated class for type {@link com.borngroup.ssl.core.jalo.components.ParagraphComponent ParagraphComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedParagraphComponent extends CMSParagraphComponent
{
	/** Qualifier of the <code>ParagraphComponent.headline</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ParagraphComponent.headline</code> attribute.
	...
	public String getHeadline(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedParagraphComponent.getHeadline requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>ParagraphComponent.headline</code> attribute. 
	...
	public void setHeadline(final SessionContext ctx, final String value)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedParagraphComponent.setHeadline requires a session language", 0 );
		}
