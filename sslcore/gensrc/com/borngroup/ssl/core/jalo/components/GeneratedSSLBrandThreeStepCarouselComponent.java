...
/**
 * Generated class for type {@link com.borngroup.ssl.core.jalo.components.SSLBrandThreeStepCarouselComponent SSLBrandThreeStepCarouselComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedSSLBrandThreeStepCarouselComponent extends ProductCarouselComponent
{
	/** Qualifier of the <code>SSLBrandThreeStepCarouselComponent.header</code> attribute **/
	public static final String HEADER = "header";
	/** Qualifier of the <code>SSLBrandThreeStepCarouselComponent.banner</code> attribute **/
	public static final String BANNER = "banner";
	/** Qualifier of the <code>SSLBrandThreeStepCarouselComponent.activeFrom</code> attribute **/
	public static final String ACTIVEFROM = "activeFrom";
	/** Qualifier of the <code>SSLBrandThreeStepCarouselComponent.activeUntil</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SSLBrandThreeStepCarouselComponent.activeFrom</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SSLBrandThreeStepCarouselComponent.activeFrom</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SSLBrandThreeStepCarouselComponent.activeUntil</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SSLBrandThreeStepCarouselComponent.activeUntil</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SSLBrandThreeStepCarouselComponent.banner</code> attribute.
	 * @return the banner - banner
	 */
	public BannerComponent getBanner(final SessionContext ctx)
	{
		return (BannerComponent)getProperty( ctx, BANNER);
	}
	 ...
	 * @return the banner - banner
	 */
	public BannerComponent getBanner()
	{
		return getBanner( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>SSLBrandThreeStepCarouselComponent.banner</code> attribute. 
	 * @param value the banner - banner
	 */
	public void setBanner(final SessionContext ctx, final BannerComponent value)
	{
	 ...
	 * @param value the banner - banner
	 */
	public void setBanner(final BannerComponent value)
	{
		setBanner( getSession().getSessionContext(), value );
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>SSLBrandThreeStepCarouselComponent.header</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SSLBrandThreeStepCarouselComponent.header</code> attribute. 
	 * @param value the header - header
	 */
