 ...
 *
 */
package com.borngroup.ssl.core.hmc;
...
/**
 * Provides necessary meta information about the sslcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class SslCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(SslCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.borngroup.ssl.core.hmc.locales";
