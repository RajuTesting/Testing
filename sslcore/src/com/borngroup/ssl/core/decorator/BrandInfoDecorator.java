 ...
 * 
 */
public class BrandInfoDecorator implements CSVCellDecorator
{
    private static final Logger LOG = Logger.getLogger(BrandInfoDecorator.class);
    ...
    public String decorate(final int position, final Map<Integer, String> srcLine)
    {
        try
        {
            ...
            {
                return brandMappingModel.getBrandInfo();
            }
        }
