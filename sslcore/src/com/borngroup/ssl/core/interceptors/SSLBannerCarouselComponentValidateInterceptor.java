...
import com.borngroup.ssl.core.model.SSLBannerCarouselComponentModel;
 ...
 *
 */
public class SSLBannerCarouselComponentValidateInterceptor implements ValidateInterceptor<SSLBannerCarouselComponentModel> {

    @Resource
    private SSLMobileWidgetLimitService sslMobileWidgetLimitService;

    @Override
    public void onValidate(final SSLBannerCarouselComponentModel model, final InterceptorContext ctx) throws InterceptorException {
        if (null != model) {
     ...
     * @param limitModelMap
     */
    private void checkAttributeLimit(final SSLBannerCarouselComponentModel model,
