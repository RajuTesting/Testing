...
public class GiftAgeGroupFacetValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider, Serializable {
    ...
    private Collection<? extends FieldValue> createFieldValue(final ApparelProductModel product, final IndexedProperty indexedProperty) {
        ...
        final String rangeName = product.getGiftAgeGroup();
